================================================================================
// Resource.h 정리
1000 - CMI4200L_DIALOG
     - SPLASH_DLG
1100 - INITIAL_DLG
1200 - WORK_DLG
1300 - MANUAL_DLG
1400 - MANUAL_FLOW_DLG
1500 - MANUAL_ELEVATOR_DLG
1600 - MANUAL_GRIPPER_DLG
1700 - MANUAL_PICKER_DLG
1800 - MANUAL_INSPECTOR_DLG
1900 - SETUP_DLG
2000 - SETUP_EQUIP_DLG
2100 - SETUP_MODEL_DLG
2200 - SETUP_MOVE_DLG (TAB1 - TAB4)
2300 - SETUP_MOTION_DLG (TAB)
2400 - SETUP_IN_OUT_DLG (TAB)
2500 - TEN_KEY_DLG (SUB1 - SUB2)
2600 - MONITOR_DLG
2700 - MONITOR_MOTION_DLG (TAB)
2800 - MONITOR_IN_OUT_DLG (TAB)
2900 - MONITOR_LOG_DLG
3000 - ERROR_DLG
3100 - MSG_BOX_DLG
3200 - NUM_PAD_DLG
3300 - KEY_PAD_DLG
...
================================================================================
    MFC 라이브러리 : CMI4200L 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 CMI4200L 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 CMI4200L 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
CMI4200L.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CCMI4200LApp 응용 프로그램
    클래스를 선언합니다.

CMI4200L.cpp
    응용 프로그램 클래스 CCMI4200LApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\CMI4200L.ico
    ...
    주 리소스 파일인 CMI4200L.rc에 의해 포함됩니다.
...
CMI4200LDlg.h, CMI4200LDlg.cpp - 대화 상자
    이 파일에는 CCMI4200LDlg 클래스가 들어 있습니다. 이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다. 대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 CMI4200L.rc에 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 CMI4200L.pch와
